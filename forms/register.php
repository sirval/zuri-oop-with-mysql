...
<head>
    ...
    <body>
        ...
        <form class="form-control w-50" method="POST" action="../action.php">
            ...
            <?php 
            $err_message = '';
            if(isset($_GET['message']) == 'error1' ){
                $err_message = 'Couldn\'t process your request';
            }
            elseif(isset($_GET['message']) == 'error2' ){
                $err_message = 'Password and Confirm Password Mismatched';
            }
            elseif(isset($_GET['message']) == 'error3' ){
